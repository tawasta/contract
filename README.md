...
[contract_mass_edit_lines](contract_mass_edit_lines/) | 14.0.1.0.0 |  | Allows mass editing contract lines from contract tree view
[contract_membership_integration](contract_membership_integration/) | 14.0.1.3.3 |  | Show memberships in contract, and end the membership if contract line is ended
